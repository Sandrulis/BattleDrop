...
export async function SubmitSidePanel({ project }: SubmitSidePanelProps) {
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
            ...
            <dl className="mt-3 space-y-2 text-xs">
              ...
              <div className="flex justify-between gap-4">
                ...
                <dd className="font-medium text-zinc-900">20 products</dd>
              </div>
              <div className="flex justify-between gap-4">
                <dt className="text-zinc-500">Voting opens</dt>
                <dd className="font-medium text-zinc-900">24h after start</dd>
              </div>
            </dl>
          </div>
        </>
